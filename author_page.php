...
.follow-btn { background: #4CAF50; color: white; }
.msg-btn { background: #e6e6e6; color: #333; }

/* POSTS SECTION (MIDDLE BUT RIGHT-LEANED) */
.posts {
    flex: 1;
    max-width: 680px;           /* Controls right alignment */
...
@media(max-width: 850px){
    ...
    .left-card { width: 100%; position: static; }
