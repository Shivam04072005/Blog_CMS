...
try {
    ...
    $stmt = $conn->prepare("SELECT id, title, author, category, date_created, content FROM posts ORDER BY id DESC");
    $stmt->execute();
...
.post h2 { margin: 0 0 6px; font-size: 24px; }
.meta { color: #777; font-size: 0.92rem; margin-bottom: 12px; }
.post p { color: #333; line-height: 1.55; }
button.read-more {
  margin-top: 8px;
  background: #4CAF50;
  color: white;
...
@media (max-width: 820px) {
  ...
  .post { width: 100%; padding: 18px; }
}
@media (max-width: 420px) {
  .post { padding: 16px; }
  .post h2 { font-size: 19px; }
  .meta { font-size: 0.85rem; }
  button.read-more { padding: 7px 12px; }
  .add-post-link { width: 50px; height: 50px; line-height: 50px; font-size: 26px; }
}
</style>
</head>
<body>
