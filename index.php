...
<style>
/* ---------------- GLOBAL DESIGN (same as post.php) ---------------- */
...
/* ---------------- POST CARD DESIGN (same as post.php design) ---------------- */
.post {
  background: white;
  padding: 22px;
  margin: 12px 0;
  ...
  <main>
    ...
    <?php foreach ($posts as $post): ?>
      <article class="post">
        ...
        <button class="read-more" onclick="location.href='post.php?id=<?= $post['id'] ?>'">
            Read More
        </button>
      </article>
    <?php endforeach; ?>
